...
def extract_stay_point(fileIndex):
    path = '../all_data'  # /data
    filename = 'traj' + fileIndex +  '_preprocess.csv'
    ...
    save_path = '../all_data'  # ../data
    save_filename = 'staypoint_' + fileIndex + '.csv'
    write2csv(staypoint_all_vis, os.path.join(save_path, save_filename))
    
if __name__ == '__main__':
    extract_stay_point('11-12-2')